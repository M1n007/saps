    ...
    <aside class="left-side sidebar-offcanvas">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="#">
                        <i class="fa fa-envelope"></i> <span>Surat Masuk</span><span class="label label-success">10</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <i class="fa fa-envelope"></i> <span>Surat Keluar</span><span class="label label-success">10</span>
                    </a>
                </li>
            </ul>
        </section>
